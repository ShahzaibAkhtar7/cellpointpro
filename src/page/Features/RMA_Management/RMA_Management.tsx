...
import RmaFeatures from "@/components/RmaFeatures/RmaFeatures";

export default function RMA_Management() {
        ...
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p
              ...
              style={{ color: "#264160" }}
            >
              Optimize your returns and RMAs with a solution designed to save
              time and money.
            </p>
          ...
          <div className="flex-1 flex justify-center">
            <img
              src="/RMAmanagement.jpg" // make sure this image is inside public/
              alt="RMA Management"
              loading="lazy"
              decoding="async"
