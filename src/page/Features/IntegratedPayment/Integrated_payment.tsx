...
import DiscoverPayment from "@/components/DiscoverPayment/DiscoverPayment";

export default function Integrated_payment() {
        ...
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p
              ...
              style={{ color: "#264160" }}
            >
              Choose the payment option that works best for you. We've integrated with top providers to ensure smooth transactions.
            </p>
          ...
          <div className="flex-1 flex justify-center">
            <img
              src="/integratedpayment.jpg" // ✅ make sure this file exists inside public/
