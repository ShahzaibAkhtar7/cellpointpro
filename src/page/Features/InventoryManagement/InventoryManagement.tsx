...
import InventoryFeature from "@/components/InventoryFeature/InventoryFeature";
        ...
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p
              ...
              style={{ color: "#264160" }}
            >
              Streamline your inventory process with intuitive solutions that
              simplify management.
            </p>
          ...
          <div className="flex-1 flex justify-center">
            <img
              src="/inventorymanagement.jpg" // make sure this is inside public/
