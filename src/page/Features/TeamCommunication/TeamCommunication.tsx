        ...
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p
              ...
              style={{ color: "#264160" }}
            >
              Make location management easy by having chats directly integrated
              into MyRepairApp for your location.
            </p>
          ...
          <div className="flex-1 flex justify-center">
            <img
              src="/teamcommunication.jpg" // make sure this image exists in /public
