...
import CustomMatrics from "@/components/CustomerMatrics/CustomMatrics";
        ...
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p
              ...
              style={{ color: "#264160" }}
            >
              Streamline customer management and tracking with our intuitive tools, built to boost customer retention and satisfaction.
            </p>
          ...
          <div className="flex-1 flex justify-center">
            <img
              src="/customermanagement.jpg" // ✅ make sure this image exists in public/
