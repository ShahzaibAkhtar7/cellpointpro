        ...
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p
              ...
              style={{ color: "#264160" }}
            >
              Streamline employee management and tracking with our intuitive tools, built to boost employee sales and retention.
            </p>
          ...
          <div className="flex-1 flex justify-center">
            <img
              src="/Employmanagement.jpg" // ✅ make sure this image exists in public/
