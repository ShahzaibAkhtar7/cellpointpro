        ...
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            <h1
              ...
              style={{ color: "#264160" }}
            >
              Prepaid Wireless Management
            </h1>
            <p
              className="mt-4 text-base md:text-lg"
              style={{ color: "#264160" }}
            >
              From Repairs to Revenue: The POS Built to Grow Your Computer Repair
              Business. Streamline your prepaid wireless activations and boost
          ...
          <div className="flex-1 flex justify-center">
            <img
              src="/prepaid.jpg" // replace with your image path in public folder
              alt="Prepaid Wireless"
