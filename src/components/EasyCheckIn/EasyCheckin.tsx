export default function EasyCheckin() {
  return (
    <div className="w-full bg-white">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-16">
        {/* Shared gradient container for all 3 sections */}
        <div className="bg-gradient-to-br from-slate-50 to-blue-50 border border-slate-200 text-slate-800 rounded-xl shadow-lg overflow-hidden">
          ...
          <section className="flex flex-col md:flex-row items-center justify-between gap-10 p-8 md:p-12 lg:p-16">
            ...
            <div className="md:w-1/2 flex justify-center order-1 md:order-1">
              <video
                ...
                playsInline
              >
                <source src="/Videos/ticketform.mp4" type="video/mp4" />
              </video>
            </div>
            ...
            <div className="md:w-1/2 space-y-8 order-2 md:order-2">
              ...
              <div className="space-y-4">
                {[
                  "Ensure accountability with staff checklists.",
                  "Customize checklists to match your process.",
                  "Automated SOPs for your ticket check-ins.",
                  "Deliver a consistent check-in experience.",
                  "Easily track your staff performance.",
                ].map((text, idx) => (
          ...
          {/* Third Section: Image Left, Text Right (fixed same bg) */}
          <section className="flex flex-col md:flex-row items-center justify-between gap-10 p-8 md:p-12 lg:p-16">
            {/* Left - Image */}
            <div className="md:w-1/2 flex justify-center order-1 md:order-2">
              <img
